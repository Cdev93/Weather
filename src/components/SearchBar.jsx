    ...
    <>
      <div className="search-bar-container">
        <div className="i-s-cont">
          {city ? (
            <button
              onClick={() => handleWeatherSearch() && handleVisibility()}
              className="search-btn"
            >
              <img src={`src/assets/weather_icons/Search.png`}></img>
            </button>
          ) : (
            <button
              className="search-btn"
            ...
            >
              <img src={`src/assets/weather_icons/Search.png`} alt="sbtn"></img>
            </button>
          )}
          <input
            type="text"
          ...
          {suggestions != '' ? (
            <button
              className="sugg-btn"
              onClick={() =>
                handleSuggestions(suggestions) && handleVisibility()
              }
            >
              {suggestions}
            </button>
